...
Home_content = html.Div(
               style={
               'background-image': f'url({encode_image("Z7.png")})',
               'height': '100vh',
               'width': '100%',
               'background-size': 'cover'},
        children=[
        html.H1("Welcome to Zomato Data Analysis and Visualization", style={'color': 'darkcyan', 'textAlign': 'center'}),
        ...
        html.H2("Zomato Dataset Overview", style={'color': 'red'}),
         html.Ul([
        html.Li("Interactive Data Exploration: Explore various aspects of the Zomato dataset such as restaurant count, cuisine preferences, and more."),
        html.Li("Insightful Visualizations: Gain insights through visually appealing charts and graphs that help understand trends and patterns."),
        html.Li("Filter Options: Customize your analysis by filtering data based on country, city, and other parameters."),
        html.Li("Dynamic Dashboard: Interact with the dashboard to dynamically update visualizations based on your selections."),
        html.Li("User-friendly Interface: Enjoy a seamless user experience with an intuitive interface."),
    ]),

        dbc.Button("Get Started", color="primary", className="mt-2",style={'textAlign': 'center'})
        ])



Explored_component=html.H3("Explored Data Analysis", style={'color': 'darkcyan', 'textAlign': 'center'})
